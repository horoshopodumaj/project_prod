...
import { Article, ArticleType, AticleBlockType } from "../types/article";
...
describe('profileSlice test', ()=> {
    ...
    test('test update Profile service fulfilled', ()=> {
        ...
        expect(articleDetailsReducer(state as ArticleDetailsSchema, fetchArticleById.fulfilled(article, '', ''))).toEqual({
            isLoading: false,
            data: article,
        })
    })
